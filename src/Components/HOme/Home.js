...
const Home = () => {
  ...
  const handlePromptSubmit = async (data) => {
    const app = await client("https://3fdf06e9e735315c0f.gradio.live"); // Replace with your Gradio interface URL
        ...
        <div className="flex justify-end pr-10">
          ...
          <div className="">
            <h1 className="text-white">
              ...
              <br />{" "}
              <span className="text-2xl text-white"> AI-Driven Melodies</span>
            </h1>
